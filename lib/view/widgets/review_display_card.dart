...
class ReviewDisplayCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final displayName =
        userName.trim().isNotEmpty ? userName.trim() : 'مستخدم';
    final clampedRating = rating.clamp(0, 5);
    final trimmedText = text.trim();
    final timeLabel = _formatReviewDate(createdAt);
        ...
        child: Column(
          ...
          children: [
            Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                _ReviewAvatar(initial: initial, imageUrl: avatarUrl),
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          _RatingBadge(rating: clampedRating),
                        ],
                      ),
                      ...
                      _StarRow(rating: clampedRating),
                    ],
                  ),
                ),
                if (isMine && (reviewId ?? 0) > 0)
...
class _ReviewAvatar extends StatelessWidget {
  const _ReviewAvatar({required this.initial, this.imageUrl});
